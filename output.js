//Sun Nov 09 2025 13:55:47 GMT+0000 (Coordinated Universal Time)
...
function _0xd35b() {
  var _0xd2d354 = ["length", "px, 0px)", "76951gmaggG", "createElement", "tncode_canvas_mark", "_tncode", "filter", "tncode.php?t=", "request", "_ok", "网络异常，请重试(E999)", "显示验证码时出错:", "tncode_msg_error", "9WuJgrn", "appendChild", "tn_code", "检测到验证按钮未正确初始化，执行补救绑定...", "clicaptcha-submit-info", "开始绑定验证按钮...", "toDataURL", "responseText", "getContext", "preventDefault", "cloneNode", "indexOf", "_cache", "status", "6665144zFapfx", "_draw_fullbg", "data", "attachEvent", "Microsoft.XMLHTTP", "touchend", "trim", "验证码系统初始化完成", "无法创建验证码弹窗元素", "pointer", "log", "alpha(opacity=", "_result", "map", "value", "stringify", "(\\s|$)", "event", "innerHTML", "tncode", "getElementsByClassName", "验证失败(", "_is_moving", "页面无验证按钮，无需绑定", "send", "image/webp", "_html", "responseXML", "验证成功", "top", "getElementsByTagName", "init", "src", "parentNode", "&nowebp=1", "animation", "slide_block_text", "readyState", "<div class=\"tncode_div_bg\" id=\"tncode_div_bg\"></div><div class=\"tncode_div\" id=\"tncode_div\"><div class=\"loading\">加载中</div><canvas class=\"tncode_canvas_bg\"></canvas><canvas class=\"tncode_canvas_mark\"></canvas><div class=\"hgroup\"></div><div class=\"tncode_msg_error\"></div><div class=\"tncode_msg_ok\"></div><div class=\"slide\"><div class=\"slide_block\"></div><div class=\"slide_block_text\">按住左边滑块后完成拼图</div></div><div class=\"tools\"><div class=\"tncode_close\"></div><div class=\"tncode_refresh\"></div></div></div>", "\n                position: absolute;\n                width: ", "_is_draw_bg", "hgroup", "none", "className", "clientX", "drawImage", "tncode_close", "failure", "px;\n                height: ", "_track_data", "_img", "opacity", "mouseup", "202204uskpPP", "_img_h", "位置不正确(E006)", "hide", "cssText", "onload", "function", "数据解密失败(E002)", "_getElement", "prototype", "tncode_canvas_bg", "onreadystatechange", "1720205VJtyfm", "createXhrObject", "script", "onclick", "_addButtonAnimation", "push", "transform: translate(", "_bindTncodeButtons", "_block_start_move", "clientY", "undefined", "tncode-ripple", "ajax created failure", "addEventListener", "getElementByClassName", "_img_loaded", "touchstart", "width", "签名验证失败(E004)", "getElementById", "未找到任何验证按钮（class=\"tncode\"）", "ontouchstart", "warn", "display", "tncode-pulse 2s ease-in-out", "tncode_div_bg", "_err_c", "click", "putImageData", "行为异常(E005)", "1426110KwhGCB", "_draw_mark", "height", "_addPulseAnimation", "touchmove", "验证码已过期，请检查当前时间(E003)", "tncode_msg_ok", "remove", "_mark_w", "touches", "_currentUrl", "cursor", "childNodes", "tncode_refresh", "_block_start_y", "162Pcbtil", "个验证按钮", "split", "style", "nodeType", "(\\s|^)", "mousedown", "_showmsg", "Msxml2.XMLHTTP", "_img_w", "_doing", "span", "\n                        <span class=\"tncode-icon\">\n                            <span class=\"ripple-dot\"></span>\n                            <span class=\"ripple-circle\"></span>\n                            <span class=\"ripple-circle-2\"></span>\n                            <span class=\"ripple-circle-3\"></span>\n                        </span>\n                        <span class=\"tncode-text\">点击进行安全验证</span>\n                    ", "refresh", "_draw_bg", "error", "POST", "transform: translate(0px, 0px)", "px;\n                pointer-events: none;\n                transform: scale(0);\n                animation: tncode-ripple-animation 0.6s ease-out;\n            ", "getBoundingClientRect", "slide_block", "_onsuccess", "_send_result_success", "_mark_offset", "open", "call", "_reset", "px;\n                top: ", "tncode_div", "滑块元素未找到，无法绑定拖动事件", "参数缺失(E001)", "1772012lUwSWA", "显示验证码弹窗...", "_block_on_end", "_bind", "replace", "2452CUrdtq", "block", "max", "random", "getTime", "_block_start_x", "_track_start_time", "show"];
  _0xd35b = function () {
    return _0xd2d354;
  };
  return _0xd35b();
...
var tncode = {
  ...
  _bind: function (_0x299fd0, _0x3ebe55, _0x132321) {
    ...
    if (!_0x299fd0) {
      console[_0x4c88c3(556)]("尝试绑定事件到空元素:", _0x3ebe55);
      return false;
    }
  ...
  show: function () {
    ...
    try {
      ...
      (!_0xfb5eab || !_0xedc332) && (console[_0x23f0bb(556)]("验证码弹窗元素未找到，重新初始化..."), tncode[_0x23f0bb(519)] = null, tncode[_0x23f0bb(467)] = {
        slide_block: null,
        slide_block_text: null,
        canvas_bg: null,
        canvas_mark: null,
      ...
      _0xfb5eab && _0xedc332 ? (tncode[_0x23f0bb(592)](), tncode[_0x23f0bb(447)] = this, _0xfb5eab[_0x23f0bb(582)][_0x23f0bb(557)] = _0x23f0bb(435), _0xedc332[_0x23f0bb(582)][_0x23f0bb(557)] = _0x23f0bb(435), console.log("验证码弹窗显示成功")) : console[_0x23f0bb(594)](_0x23f0bb(477));
    } catch (_0x454389) {
  ...
  init: function () {
    ...
    if (!_0x1081a0 || _0x1081a0[_0x1373d9(442)] === 0) {
      console[_0x1373d9(479)]("页面无验证按钮，跳过验证码系统初始化");
      return;
    }
    console.log("检测到验证按钮，开始初始化验证码系统...");
  ...
  _bindTncodeButtons: function () {
    ...
    if (_0x4f9f9f && _0x4f9f9f.length > 0) {
      console.log("找到", _0x4f9f9f[_0x44800e(442)], "个验证按钮");
      var _0x233678 = 0;
      ...
      console[_0x44800e(479)]("成功绑定", _0x233678, _0x44800e(580));
    } else {
